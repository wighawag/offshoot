...
Initial release of `offshoot-fanout`: the maintainer-side companion to `offshoot`. Keep a template tree's `stem` remotes current from changes anywhere in the hierarchy.
